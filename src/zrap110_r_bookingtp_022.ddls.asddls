...
@ObjectModel.sapObjectNodeType.name: 'ZRAP110_Booking_022'
define view entity ZRAP110_R_BOOKINGTP_022
  as select from ZRAP110_ABOOK022 as Booking
  association to parent ZRAP110_R_TRAVELTP_022 as _Travel on $projection.TravelID = _Travel.TravelID
