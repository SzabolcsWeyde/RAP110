...
define root view entity ZRAP110_C_TRAVELTP_022
  provider contract transactional_query
  as projection on ZRAP110_R_TRAVELTP_022

{
  ...
  key     TravelID,
          ...
          @ObjectModel.virtualElementCalculatedBy: 'ABAP:ZRAP110_CALC_TRAV_ELEM_022'
  virtual OverallStatusIndicator : abap.int2,
          ...
          // public associations
          _Booking : redirected to composition child ZRAP110_C_BOOKINGTP_022,
