class ZRAP110_EML_PLAYGROUND_022 definition
  public
  final
  create public .
...
CLASS ZRAP110_EML_PLAYGROUND_022 IMPLEMENTATION.


METHOD IF_OO_ADT_CLASSRUN~MAIN.
     "declare internal table using derived type
     DATA travel_keys TYPE TABLE FOR READ IMPORT ZRAP110_R_TravelTP_022 .

     "fill in relevant travel keys for READ request
     travel_keys = VALUE #( ( TravelID = '3' )
                           "( TravelID = '...' )
                          ).
